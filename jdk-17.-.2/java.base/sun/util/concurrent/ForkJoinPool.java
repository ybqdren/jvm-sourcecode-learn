...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    public <T> List<java.util.concurrent.Future<T>> invokeAll(Collection<? extends java.util.concurrent.Callable<T>> tasks) {
        ...
        try {
            ...
            for (java.util.concurrent.Future<T> e : futures)
    ...
    static final class InvokeAnyRoot<E> extends ForkJoinTask<E> {
        ...
        final void tryComplete(java.util.concurrent.Callable<E> c) { // called by InvokeAnyTasks
            Throwable ex = null;
            boolean failed;
    ...
    static final class InvokeAnyTask<E> extends ForkJoinTask<E> {
        ...
        @SuppressWarnings("serial") // Conditionally serializable
        final java.util.concurrent.Callable<E> callable;
        transient volatile Thread runner;
        InvokeAnyTask(InvokeAnyRoot<E> root, java.util.concurrent.Callable<E> callable) {
            this.root = root;
