...
public abstract class ForkJoinTask<V> implements java.util.concurrent.Future<V>, Serializable {
     ...
     */
    private int awaitDone(java.util.concurrent.ForkJoinPool pool, boolean ran,
                          boolean interruptible, boolean timed,
                          long nanos) {
        java.util.concurrent.ForkJoinPool p; boolean internal; int s; Thread t;
        java.util.concurrent.ForkJoinPool.WorkQueue q = null;
        if ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread) {
            ...
            internal = false;
            p = java.util.concurrent.ForkJoinPool.common;
            if (pool == null)
                pool = p;
            if (pool == p && p != null)
                q = p.externalQueue();
    ...
    final void awaitPoolInvoke(java.util.concurrent.ForkJoinPool pool) {
        awaitDone(pool, false, false, false, 0L);
    }
    final void awaitPoolInvoke(java.util.concurrent.ForkJoinPool pool, long nanos) {
        awaitDone(pool, false, true, true, nanos);
    }
    final V joinForPoolInvoke(java.util.concurrent.ForkJoinPool pool) {
        int s = awaitDone(pool, false, false, false, 0L);
        if ((s & ABNORMAL) != 0)
            reportException(s);
        return getRawResult();
    }
    final V getForPoolInvoke(java.util.concurrent.ForkJoinPool pool)
    ...
    final V getForPoolInvoke(java.util.concurrent.ForkJoinPool pool, long nanos)
        throws InterruptedException, ExecutionException, TimeoutException {
    ...
    public static void helpQuiesce() {
        Thread t; ForkJoinWorkerThread w; java.util.concurrent.ForkJoinPool p;
        if ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread &&
            (p = (w = (ForkJoinWorkerThread)t).pool) != null)
            p.helpQuiescePool(w.workQueue, Long.MAX_VALUE, false);
        else
            java.util.concurrent.ForkJoinPool.common.externalHelpQuiescePool(Long.MAX_VALUE, false);
    }
    ...
    public boolean tryUnfork() {
        ...
        return ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread)
            ? (q = ((ForkJoinWorkerThread)t).workQueue) != null
               && q.tryUnpush(this)
            : (q = java.util.concurrent.ForkJoinPool.commonQueue()) != null
    ...
    public static int getQueuedTaskCount() {
        ...
        if ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread)
            ...
            q = java.util.concurrent.ForkJoinPool.commonQueue();
    ...
    static final class AdaptedInterruptibleCallable<T> extends ForkJoinTask<T>
        ...
        T result;
        AdaptedInterruptibleCallable(java.util.concurrent.Callable<? extends T> callable) {
            if (callable == null) throw new NullPointerException();
            this.callable = callable;
        }
        public final T getRawResult() { return result; }
