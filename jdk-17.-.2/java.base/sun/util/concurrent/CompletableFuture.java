...
public class CompletableFuture<T> implements java.util.concurrent.Future<T>, java.util.concurrent.CompletionStage<T> {
    ...
    static final class UniExceptionally<T> extends UniCompletion<T,T> {
        ...
        UniExceptionally(java.util.concurrent.Executor executor,
    ...
    private CompletableFuture<T> uniExceptionallyStage(
            java.util.concurrent.Executor e, Function<Throwable, ? extends T> f) {
        if (f == null) throw new NullPointerException();
        CompletableFuture<T> d = newIncompleteFuture();
        Object r;
        if ((r = result) == null)
    ...
    static final class UniComposeExceptionally<T> extends UniCompletion<T,T> {
        Function<Throwable, ? extends java.util.concurrent.CompletionStage<T>> fn;
        UniComposeExceptionally(java.util.concurrent.Executor executor, CompletableFuture<T> dep,
                                CompletableFuture<T> src,
                                Function<Throwable, ? extends java.util.concurrent.CompletionStage<T>> fn) {
            super(executor, dep, src); this.fn = fn;
        }
        final CompletableFuture<T> tryFire(int mode) {
            CompletableFuture<T> d; CompletableFuture<T> a;
            Function<Throwable, ? extends java.util.concurrent.CompletionStage<T>> f;
    ...
    private CompletableFuture<T> uniComposeExceptionallyStage(
            java.util.concurrent.Executor e, Function<Throwable, ? extends java.util.concurrent.CompletionStage<T>> f) {
        if (f == null) throw new NullPointerException();
        CompletableFuture<T> d = newIncompleteFuture();
    ...
    public CompletableFuture<T> exceptionallyAsync(
        Function<Throwable, ? extends T> fn, java.util.concurrent.Executor executor) {
