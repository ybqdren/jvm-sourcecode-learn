...
public class ForkJoinWorkerThread extends Thread {
     ...
     */
    ForkJoinWorkerThread(ThreadGroup group, java.util.concurrent.ForkJoinPool pool,
        ...
        this.workQueue = new java.util.concurrent.ForkJoinPool.WorkQueue(this, isInnocuous);
     ...
     */
    /* TODO: protected */ ForkJoinWorkerThread(ThreadGroup group, java.util.concurrent.ForkJoinPool pool) {
    ...
    public void run() {
        ...
        java.util.concurrent.ForkJoinPool.WorkQueue w = workQueue;
