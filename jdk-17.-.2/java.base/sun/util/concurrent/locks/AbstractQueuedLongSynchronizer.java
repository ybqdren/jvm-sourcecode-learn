...
package sun.util.concurrent.locks;
...
public abstract class AbstractQueuedLongSynchronizer
    ...
    static final class ConditionNode extends Node
        ...
        public final boolean block() {
            while (!isReleasable()) java.util.concurrent.locks.LockSupport.park();
            return true;
        }
    }
            ...
            for (;;) {
                ...
                if (t == null)                 // initialize
                    ...
                    if (t.status < 0)          // wake up to clean link
                        java.util.concurrent.locks.LockSupport.unpark(node.waiter);
                    break;
                }
            }
        }
    ...
    private static void signalNext(Node h) {
        ...
        if (h != null && (s = h.next) != null && s.status != 0) {
            ...
            java.util.concurrent.locks.LockSupport.unpark(s.waiter);
        }
    }
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
        ...
        public final void awaitUninterruptibly() {
            ...
            java.util.concurrent.locks.LockSupport.setCurrentBlocker(this); // for back-compatibility
            ...
            java.util.concurrent.locks.LockSupport.setCurrentBlocker(null);
            node.clearStatus();
