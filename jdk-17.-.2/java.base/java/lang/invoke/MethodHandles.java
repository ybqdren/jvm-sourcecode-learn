...
public class MethodHandles {
     ...
     * </tr>
     * <tr>
     *     <th scope="row">{@link Lookup#unreflectSpecial lookup.unreflectSpecial(aMethod,this.class)}</th>
     *     <td>{@code T m(A*);}</td><td>{@code (T) super.m(arg*);}</td>
     * </tr>
     * <tr>
    ...
    class Lookup {
         ...
         * and {@linkplain ProtectionDomain protection domain}
         ...
         * ASCII periods. For the instance of {@link Class} representing {@code C}:
         * <ul>
